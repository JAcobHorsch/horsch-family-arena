...
const WORLDS = [
  {
    ...
    enemies: {
      ...
      brute:   { name: 'Trash Panda',       color: '#8d8d96', color2: '#3a3a42', accessory: 'mask', signature: 'thief', body: 'panda' },
      shooter: { name: 'Sprinkler Sentry',  color: '#5fae6a', color2: '#24482a', accessory: 'antenna', body: 'sprinkler' },
  ...
  },
  {
    ...
    enemies: {
      ...
      brute:   { name: 'Rust Golem',      color: '#b06a32', color2: '#4d2a10', accessory: 'bolts', body: 'golem' },
      shooter: { name: 'Grease Spitter',  color: '#3a3a2a', color2: '#e8c84a', accessory: 'drip', body: 'grease' },
  ...
  },
  {
    ...
    enemies: {
      ...
      brute:   { name: 'Rest-Stop Sasquatch', color: '#6a4a32', color2: '#2c1e12', accessory: 'ears', body: 'squatch' },
      shooter: { name: 'Speed Camera',        color: '#6a7288', color2: '#282c3a', accessory: 'antenna', body: 'camera' },
  ...
  },
  {
    ...
    enemies: {
      ...
      brute:   { name: 'Ogre',      color: '#5f8a3a', color2: '#243a12', accessory: 'imphorns', body: 'ogre' },
      shooter: { name: 'Dark Mage', color: '#7a4ae8', color2: '#2c1460', accessory: 'wizardhat', body: 'mage' },
